...
- [ ] Create `apps/web/src/app/api/folder/index.ts` barrel export
- [ ] Create `apps/web/src/lib/local-folder-storage.ts` for localStorage folder management (guests)
...
- [ ] Create E2E tests for folder CRUD in localStorage mode at `apps/web/e2e/folders.spec.ts`:
  ...
  - [ ] E2E: Delete folder (todos move to Inbox)
  - [ ] E2E: Reorder folders via drag-and-drop
  - [ ] E2E: Assign todo to folder
  - [ ] E2E: Filter todos by folder
  - [ ] E2E: Persist folders after page reload
...
- [ ] Create `apps/web/src/app/api/subtask/subtask.types.ts` with TypeScript types and Zod schemas
- [ ] Add unit tests for subtask types/schemas in `apps/web/src/app/api/subtask/subtask.types.test.ts`
