...
// Since vi.mock is hoisted, we need to use the actual import pattern
// and access the mock through the module
vi.mock("./analytics.supabase", () => ({
	getCompletionHistorySupabase: vi.fn(),
}));

// Get a reference to the mocked function for use in tests
const mockGetCompletionHistorySupabase =
	getCompletionHistorySupabase as ReturnType<typeof vi.fn>;
