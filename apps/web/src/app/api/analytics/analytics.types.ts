...
/**
 * Schema for recurring occurrences date range input
 */
export const getRecurringOccurrencesInputSchema = z.object({
	startDate: z.string().datetime(),
	endDate: z.string().datetime(),
});
...
>;
export type GetRecurringOccurrencesInput = z.infer<
	typeof getRecurringOccurrencesInputSchema
>;
...
/**
 * Status of a recurring occurrence
 */
export type RecurringOccurrenceStatus = "completed" | "missed" | "pending";

/**
 * A recurring todo occurrence with its completion status.
 * Generated by merging expected occurrences with actual completion records.
 */
export interface RecurringOccurrenceWithStatus {
	/** Unique identifier for this occurrence (todoId-scheduledDate) */
	id: string;
	/** The recurring todo ID */
	todoId: string | number;
	/** The text/title of the recurring todo */
	todoText: string;
	/** The date this occurrence was scheduled for */
	scheduledDate: Date;
	/** When the occurrence was completed, null if not completed */
	completedAt: Date | null;
	/** Status of this occurrence: completed, missed, or pending (future) */
	status: RecurringOccurrenceStatus;
	/** Whether this occurrence has been recorded in completion history */
